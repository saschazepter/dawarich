  ...
  module Writers
    class TrackWriter
      ...
      def upsert(extracted, skip_segment_detection: false)
        ...
        if points.size < 2
          adopted = adopt_generated_track(extracted, skip_segment_detection)
      ...
      def adopt_generated_track(extracted, skip_segment_detection)
        ...
        rebuild_segments(track, skip_segment_detection)
      end
