...
- Traccar KML exports now import LineString points instead of completing with zero points. Traccar records only a start and end time per track, so each point in between is given an estimated time spread evenly across that range (#3120)
