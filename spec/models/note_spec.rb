...
RSpec.describe Note, type: :model do
  ...
  describe 'validations' do
    ...
    it { is_expected.to validate_length_of(:body).is_at_most(Note::MAX_BODY_LENGTH) }
  ...
  describe 'body' do
    ...
    it 'stores body as a plain string' do
      expect(note.body).to eq('A wonderful day exploring the city')
    end
  end
